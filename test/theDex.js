...
const Dai = artifacts.require('tokenMocks/Dai.sol');
const Bat = artifacts.require('tokenMocks/Bat.sol');
const Rep = artifacts.require('tokenMocks/Rep.sol');
const Zrx = artifacts.require('tokenMocks/Zrx.sol');
const Dex = artifacts.require('theDex.sol');
